...
def members_of_knesset_by_date():
    """
    This function creates a table for members of knesset by date.
    """
    today = date.today()
    ...
    members_of_knesset_by_date.columns = ['date', 'person_id']
    members_of_knesset_by_date.to_csv(
        '..\data\\transformed\\members_of_knesset_by_date.csv',
        index=False
        )
