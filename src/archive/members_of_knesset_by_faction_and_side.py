...
# ===================   import data   ===================
factions_side = pd.read_csv('..\..\data\\expanded\\factions_side.csv',
    parse_dates=['Date'])
factions_side
...
members_of_knesset_by_faction = members_of_knesset_by_date.set_index(['Date', 'PersonID']).join(
    members_of_faction_by_date.set_index(['Date', 'PersonID']), how='left')
...
members_of_knesset_by_faction_and_side = members_of_knesset_by_faction.set_index(['Date', 'FactionID']).join(
    factions_side.set_index(['Date', 'FactionID']), how='left')
